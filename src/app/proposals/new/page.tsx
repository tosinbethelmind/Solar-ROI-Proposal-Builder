      ...
      <div className="max-w-6xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center bg-white dark:bg-slate-900 p-4 rounded-2xl border shadow-sm gap-3">
          ...
          <div className="flex items-center gap-3">
            <HardHat className={`w-4 h-4 ${fieldMode ? 'text-teal-600' : 'text-slate-400'}`} />
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl p-6 sm:p-8 shadow-sm space-y-6">
              ...
              <form onSubmit={handleQuickSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1.5">
                    <label className="text-xs font-bold text-slate-700 dark:text-slate-300">System Size (kVA)</label>
                    <select
                      value={quickKva}
                ...
                <Button
                  type="submit"
                  className="w-full h-12 bg-teal-650 hover:bg-teal-705 text-white font-bold rounded-2xl text-sm transition-all shadow-md mt-2"
                >
