...
export default function InteractiveProposalPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  React.useEffect(() => {
    ...
    async function trackViewed() {
      try {
        ...
        // Update status to Viewed only if it's currently 'Sent'
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-white font-sans pb-32">
      ...
      <main className="max-w-3xl mx-auto px-6 py-8 space-y-8">
        ...
        <section className="bg-gradient-to-br from-slate-900 to-slate-950 border border-slate-800 rounded-3xl p-6 shadow-xl relative overflow-hidden">
        ...
        <section className="bg-slate-900 border border-slate-800 rounded-3xl p-6 space-y-4">
          <h3 className="text-base font-bold text-white flex items-center gap-2">
            <ShieldCheck className="w-5 h-5 text-emerald-400" /> Lagos Building & Fire Compliance
          </h3>
          <p className="text-xs text-slate-400 leading-relaxed">
          ...
          {proposal.tracking_status === 'Approved' ? (
            ...
            <>
              ...
              <Button 
                ...
                className="flex-1 py-6 bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-black rounded-xl text-xs flex items-center justify-center gap-2"
              >
                Approve & Book Survey
              </Button>
            </>
