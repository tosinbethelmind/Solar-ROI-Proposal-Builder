    ...
    <div className="group flex items-center justify-between gap-4 rounded-xl border bg-white dark:bg-slate-900 p-4 border-slate-200 dark:border-slate-800 transition-all hover:shadow-md hover:border-teal-500/30 dark:hover:border-teal-500/20">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="flex gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
          <Button size="sm" variant="ghost" className="h-8 px-3 text-xs bg-slate-550 hover:bg-teal-50 text-teal-650 dark:bg-slate-800 dark:hover:bg-slate-750 font-bold rounded-xl" onClick={onLoad}>Open</Button>
...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-550 transition-colors duration-300">
      {/* ═══ Top Nav ═══ */}
          ...
          <section className="relative overflow-hidden rounded-3xl border border-teal-500/20 bg-gradient-to-br from-teal-900 to-slate-950 p-8 sm:p-10 text-white shadow-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
              ...
              <div className="flex flex-col sm:flex-row gap-3 shrink-0">
                <Button
                  size="lg"
                  className="bg-teal-550 hover:bg-teal-650 text-white font-bold shadow-lg hover:shadow-xl transition-all rounded-2xl flex items-center justify-center gap-2 text-sm px-6 h-12"
          ...
          {[
            ...
            <Card key={tip.title} className="bg-slate-100/50 dark:bg-slate-900 border-none">
              <CardContent className="flex items-start gap-3 pt-5 pb-4">
                ...
                <div>
                  <p className="font-bold text-xs text-slate-800 dark:text-slate-200">{tip.title}</p>
